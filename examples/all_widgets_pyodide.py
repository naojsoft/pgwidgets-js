"""
All Widgets demo -- Pyodide version.

This is the Python equivalent of all_widgets.html, loaded and run
in the browser via Pyodide. See all_widgets_pyodide.html for the
HTML loader.
"""
...
top = Widgets.TopLevel(title="All Widgets Demo (Pyodide)", resizable=True)
...
print("All Widgets Pyodide demo ready!")
