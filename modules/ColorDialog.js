...
class ColorDialog extends Dialog {
    ...
    constructor(options = {}) {
        ...
        // set initial color
        let initColor = options.color || '#ff0000';
    ...
    _buildButtons() {
        ...
        okBtn.add_callback('activated', () => {
            this.make_callback('activated', this._hexFromHSV());
            this.hide();
        });
    ...
    /** @private */
    _hexToRGB(hex) {
        // handle rgb(r, g, b) format (browsers return this from style props)
